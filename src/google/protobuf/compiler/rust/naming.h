...
// collisions It is still possible to create a message definition that will have
// a collision, and it may rename a field even if there's no collision (as in
// the case of x_mut in the example).
//
